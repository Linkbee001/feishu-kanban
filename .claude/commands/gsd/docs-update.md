...
<execution_context>
@C:/workspace/feishu-kanban/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/workspace/feishu-kanban/.claude/get-shit-done/workflows/docs-update.md end-to-end.
