...
Use template from `C:/workspace/feishu-kanban/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/workspace/feishu-kanban/.claude/get-shit-done/templates/UI-SPEC.md`
