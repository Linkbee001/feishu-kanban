...
<reference>
@C:/workspace/feishu-kanban/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/workspace/feishu-kanban/.claude/get-shit-done/references/user-profiling.md` to load:
