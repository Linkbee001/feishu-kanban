...
Reference full template: `C:/workspace/feishu-kanban/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/workspace/feishu-kanban/.claude/get-shit-done/templates/state.md`.
