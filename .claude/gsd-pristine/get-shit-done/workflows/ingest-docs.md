...
```bash
INIT=$(node "C:/workspace/feishu-kanban/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/workspace/feishu-kanban/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
