...
```markdown
Read C:/workspace/feishu-kanban/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/workspace/feishu-kanban/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/workspace/feishu-kanban/.claude/agents/gsd-ui-checker.md for instructions.
