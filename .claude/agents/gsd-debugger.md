...
<required_reading>
@C:/workspace/feishu-kanban/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/workspace/feishu-kanban/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/workspace/feishu-kanban/.claude
                  → checks C:/workspace/feishu-kanban/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/workspace/feishu-kanban/.claude/get-shit-done
                  → writes to C:/workspace/feishu-kanban/.claude/get-shit-done/hooks/
...
@C:/workspace/feishu-kanban/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/workspace/feishu-kanban/.claude/get-shit-done/references/common-bug-patterns.md
