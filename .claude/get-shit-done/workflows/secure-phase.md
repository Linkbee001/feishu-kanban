...
```
Task(
  prompt="Read C:/workspace/feishu-kanban/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/workspace/feishu-kanban/.claude/get-shit-done/templates/SECURITY.md`
