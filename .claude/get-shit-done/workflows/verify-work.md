...
Read and follow `C:/workspace/feishu-kanban/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @C:/workspace/feishu-kanban/.claude/get-shit-done/workflows/diagnose-issues.md
