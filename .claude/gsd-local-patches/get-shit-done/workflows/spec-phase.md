...
```bash
INIT=$(node "C:/workspace/feishu-kanban/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/workspace/feishu-kanban/.claude/get-shit-done/templates/spec.md.
