...
INSTALL_JS_GLOBAL="C:/workspace/feishu-kanban/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/workspace/feishu-kanban/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
